...
1. **Techno-Animist Ethics**  
   *Philosophical Foundations*  
   — Rethinking agency, matter, and responsibility beyond mechanistic AI ethics.

2. **Dynamic Ethical Boundary Lines**  
   *Logical & Structural Framework*  
   — How ethical boundaries shift, rupture, and stabilize across layers.

3. **Boundary OS**  
   *System Architecture & Governance Model*  
   — A five-layer, non-dominant AI-mediated operating system for societies.

4. **Boundary Stability Index (BSI)**  
   *Applied Metrics & Policy Evaluation*  
   — Measuring boundary stress in migration, digital governance, and crisis response.

## Appendices & Implementation Resources

The appendices function as a **practical evidence layer**:
they demonstrate that Boundary OS is not only conceptual, but executable.

- **Appendix F** — Technical & Mathematical Annex  
- **Appendix F.9** — Boundary Stability Index (BSI) Specification  
...
Alongside policy and research, Boundary OS is explored through:
- Generative visuals
- Narrative experiments
- Sound and spatial works

These pieces examine boundaries where language and policy alone are insufficient.
